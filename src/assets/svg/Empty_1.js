...
export default function  ({color = 'black', width = 128, height = 82}) {
  return ( 
    <Svg class="ant-empty-img-simple" width={width} height={height} viewBox="0 0 64 41" xmlns="http://www.w3.org/2000/svg">
